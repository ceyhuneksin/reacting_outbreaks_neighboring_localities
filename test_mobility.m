...
Peaks = zeros(N,20,5); %zeros(N,34,5);
T_Peak = zeros(N,20,5);
Final_Size = zeros(N,20,5);
ii = 1; jj=1; 

    for lambda_ijs = [1:50:1000]; %[1:3:100]
        lambda_ij = (ones(N,N)-diag(ones(N,1)))*lambda_ijs/100000; %1000000 baseline immigration constant
        for omega_2 = [0:0.25:1]
            ...
            kappa(1) = 1;
            kappa(2) = 1;
            alpha_ij = ones(N,1)*1; % NOT USED ANYMORE
...
plot(0.001:0.05:1,Final_Size(2,:,2)-Final_Size(2,:,1),'LineWidth',2,'MarkerSize',8)
plot(0.001:0.05:1,Final_Size(2,:,3)-Final_Size(2,:,1),'LineWidth',2,'MarkerSize',8)
plot(0.001:0.05:1,Final_Size(2,:,4)-Final_Size(2,:,1),'LineWidth',2,'MarkerSize',8)
plot(0.001:0.05:1,Final_Size(2,:,5)-Final_Size(2,:,1),'LineWidth',2,'MarkerSize',8)
